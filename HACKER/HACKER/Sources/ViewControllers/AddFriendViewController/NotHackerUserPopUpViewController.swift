//
//  NotHackerUserViewController.swift
//  HACKER
//
...
//MARK: - NotHackerUserViewController
class NotHackerUserPopUpViewController: UIViewController {
...
//    self.view.backgroundColor = .hackerWhite
  ...
  func layoutUnknownUserLabel() {
    self.rectangleBackgroundView.add(unknownUserLabel) {
      $0.setupLabel(text: "해커에 가입되지 않은 유저입니다.", color: .hackerBlack, font: .subtitleMedium(ofSize: 16))
      $0.snp.makeConstraints {
